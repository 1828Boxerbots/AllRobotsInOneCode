...
void RobotContainerC418::ConfigureAutonomousCommands()
{
  ...
  //  frc2::InstantCommand{[this] {if(m_pDrive != nullptr) m_pDrive->Init(); }, {m_pDrive}},
    ...
    frc2::InstantCommand{[this] {if(m_pDrive != nullptr) m_pDrive->TurnWithVision(0.75, 30); }, {m_pDrive}},
    ...
    frc2::InstantCommand{[this] {if(m_pDrive != nullptr) m_pDrive->TurnWithVision(-1.0, 50); }, {m_pDrive}},
